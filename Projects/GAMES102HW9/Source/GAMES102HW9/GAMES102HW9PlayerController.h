...
#include "GAMES102HW9PlayerController.generated.h"
...
struct GAMES102HW9_API FInputParams
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class GAMES102HW9_API AGAMES102HW9PlayerController : public ACGDemoPlayerController3D
{
	GENERATED_BODY()
public:
	DECLARE_DELEGATE(FOnTimerHandleValidityChanged);

	AGAMES102HW9PlayerController(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
