...
public:
	...
	UFUNCTION(BlueprintGetter)
	FText GetTextSimpRatio();

	UFUNCTION(BlueprintGetter)
	FText GetTextLoopCount();

	UFUNCTION(BlueprintGetter)
	float GetSpinBoxSimpRatio();
...
public:
	...
	UFUNCTION(BlueprintCallable)
	void CommitSpinBoxSimpRatio(float InValue, ETextCommit::Type CommitMethod);
