 ...
 */
class SArteriesViewport : public SEditorViewport
{
public:
	SLATE_BEGIN_ARGS(SArteriesViewport){}
...
private:
	...
	/** Viewport client */
	TSharedPtr<class FArteriesViewportClient> ViewportClient;
