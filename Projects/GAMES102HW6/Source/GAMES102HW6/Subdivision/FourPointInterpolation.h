...
struct GAMES102HW6_API FFourPointInterpolationParams : public FSubdivisionParamsBase
{
	double InAlpha = 0.0625;
};

class GAMES102HW6_API FFourPointInterpolation : public FSubdivisionBase
{
public:
