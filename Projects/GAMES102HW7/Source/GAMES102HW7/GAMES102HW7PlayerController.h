...
#include "GAMES102HW7PlayerController.generated.h"
...
struct GAMES102HW7_API FInputParams
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class GAMES102HW7_API AGAMES102HW7PlayerController : public ACGDemoPlayerController3D
{
	GENERATED_BODY()
public:
	DECLARE_DELEGATE(FOnTimerHandleValidityChanged);

	AGAMES102HW7PlayerController(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
